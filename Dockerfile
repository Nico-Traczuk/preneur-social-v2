...
#   - Ex: hexpm/elixir:1.16.3-erlang-26.2.5.9-debian-bullseye-20250317-slim
#
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/project_social_networks ./
